...
import libs.nnet3.train.frame_level_objf_tmp as train_lib
...
def train(args, run_opts):
    ...
    print("Zeek:step8.1:train_raw_dnn: #_archives={}, args.frames_per_eg={}, #_archives_expanded={}, args.num_epochs={}, num_archives_to_process".format(num_archives, args.frames_per_eg, num_archives_expanded, args.num_epochs, num_archives_to_process))
    print("Zeek:step8.2:train_raw_dnn: iter={}, num_archives_to_process={}, #_jobs_init={}, #_jobs_final={}".format(num_iters, num_archives_to_process, args.num_jobs_initial, args.num_jobs_final))
    ...
    for iter in range(num_iters):
        ...
        if args.stage <= iter:
            ...
            print('zzz: iter={}, num_archives_to_process={}, df={}'.format(iter, num_archives_to_process, 
...
def main():
    ...
    try:
        print("Zeek:step8.1:train_raw_dnn: #jobs_init={}, #jobs_final".format(args.num_jobs_initial, args.num_jobs_final))
        train(args, run_opts)
