...
def _get_component_dropout(dropout_schedule, data_fraction):
    ...
    if dropout_schedule_index == 0:
        # dropout_schedule_index: tuple, len==2
        # [0] = str '*',  [1] = list , len==4
        #   (1.0, 0.0)
        #   (0.5, 0.1)
        #   (0.2, 0.0)
        #   (0, 0.0)
        print(' zzz-test-2', type(dropout_schedule), type(dropout_schedule[0]), type(dropout_schedule[0][0]), dropout_schedule[0][0], data_fraction)
        #print(' zzz-test-2', type(dropout_schedule), type(data_fraction), dropout_schedule_index, data_fraction)
...
def get_dropout_edit_string(dropout_schedule, data_fraction, iter_):
    ...
    #   (0.2, 0.0)
    #   (0, 0.0)
    print(' zzz-test-1', type(dropout_schedule), type(data_fraction),  dropout_schedule, data_fraction)
