...
nnet_dir="/media/sangjik/hdd2/speaker_verification/kaldi/xvector_nnet_1a.total_dnn_from_17_5layers"
...
#  local/nnet3/xvector/prepare_feats_for_egs_for1msecResolution.sh --nj $num_cpu --cmd "$train_cmd" \
#    data/train_combined data/train_combined_no_sil /media/sangjik/hdd2/exp/train_combined_no_sil
#    echo stage_4.1  `date`
...
local/nnet3/xvector/run_xvector.total.dnn_from17_5layers.sh --stage $stage --train-stage -1 \
